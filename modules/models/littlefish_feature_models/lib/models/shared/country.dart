...
class Country {
  String isoCode, currencyCode, currencyName, name, iso3Code;
...
class CountryHelper {
  ...
  static Country getCountryByName(String countryName) {
    try {
      ...
      throw Exception(
        'The initialValue provided is not a supported country name!',
      );
    }
  }

  static CountryStub fromCountry(Country value) {
    var callingCode = DCodes().getDiallingCode(value.isoCode);
    return CountryStub(
      countryCode: value.isoCode,
      countryName: value.name,
      diallingCode: callingCode.substring(1),
      currencyCode: value.currencyCode,
      countryCodeFull: value.iso3Code,
      enabled: true,
      shortCurrencyCode: value.currencyCode,
    );
  }
}

class DCodes {
  String? countryCode, name, callingCode, flag;

  DCodes({this.callingCode, this.countryCode, this.flag, this.name});

  String getDiallingCode(String isoCode) => dCodes
      .map((e) => fromJson(e))
      .firstWhere((element) => element.countryCode == isoCode)
      .callingCode!;

  DCodes fromJson(Map<String, String> json) {
    var c = DCodes(
...
final List<Map<String, String>> dCodes = [
  {
    'country_code': 'AF',
    'name': 'Afghanistan',
    'calling_code': '+93',
