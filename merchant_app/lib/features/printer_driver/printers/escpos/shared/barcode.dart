class BarcodeType {
  ...
  static const interleaved2of5 = BarcodeType._internal(5);
  static const codabarNW7 = BarcodeType._internal(6);
}

class BarcodeText {
  const BarcodeText._internal(this.value);
  final int value;
  static const notPrinted = BarcodeText._internal(0);
  static const above = BarcodeText._internal(1);
  static const below = BarcodeText._internal(2);
  static const bothAboveAndBelow = BarcodeText._internal(3);
}
...
class Barcode {
  ...
  Barcode.itf(List<dynamic> barcodeData) {
    ...
    _type = BarcodeType.interleaved2of5;
    _data = _convertData(barcodeData);
  }
  ...
  Barcode.codabar(List<dynamic> barcodeData) {
    ...
    _type = BarcodeType.codabarNW7;
    _data = _convertData(barcodeData);
  }

  // TODO(lampian): refactor next lines into cleaner implementation
