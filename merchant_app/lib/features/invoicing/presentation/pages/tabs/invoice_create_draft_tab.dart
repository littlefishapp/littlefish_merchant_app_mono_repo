...
class InvoiceCreateDraftTab extends StatefulWidget {
  final Order invoice;
  ...
  @override
  State<InvoiceCreateDraftTab> createState() => _InvoiceCreateDraftTabState();
}

class _InvoiceCreateDraftTabState extends State<InvoiceCreateDraftTab>
  ...
  Widget build(BuildContext context) {
    ...
    return StoreConnector<AppState, InvoicingViewModel>(
      ...
      builder: (context, vm) {
        ...
        final dueDate = vm.dueDate ?? DateTime.now();
                ...
                child: Column(
                  children: [
                    Align(
                      ...
                      child: context.labelSmall('Create Invoice', isBold: true),
                    ),
