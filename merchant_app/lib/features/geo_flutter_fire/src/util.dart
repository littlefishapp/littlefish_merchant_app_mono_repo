...
import 'package:littlefish_merchant/features/geo_flutter_fire/geo_flutter_fire_export.dart';
...
class Util {
  ...
  String neighbor(String hashString, var direction) {
    ...
    var neighborLat =
        lonLat['latitude'] ?? 0 + direction[0] * lonLat['latitudeError'] * 2;
    var neighborLon =
        lonLat['longitude'] ?? 0 + direction[1] * lonLat['longitudeError'] * 2;
  ...
  List<String> neighbors(String hashString) {
    ...
    double latErr = lonlat['latitudeError'] ?? 0.0 * 2;
    double lonErr = lonlat['longitudeError'] ?? 0.0 * 2;
  ...
  static const double earthMeridionalCircumreference = 40007860;

  // The equatorial radius of the earth in meters
  static const double eartEqRadius = 6378137;
  ...
  static double calcDistance(
    ...
    const double radius = (eartEqRadius + earthPolarRadius) / 2;
