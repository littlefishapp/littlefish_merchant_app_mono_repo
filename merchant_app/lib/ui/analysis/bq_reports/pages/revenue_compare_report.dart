...
class BqReportingCompareRevenuePage extends StatefulWidget {
  static const String route = 'bq/reporting/revenue/compare';

  const BqReportingCompareRevenuePage({Key? key}) : super(key: key);

  @override
  State<BqReportingCompareRevenuePage> createState() =>
      _BqReportingCompareRevenuePage();
}

class _BqReportingCompareRevenuePage
    extends State<BqReportingCompareRevenuePage>
  ...
  String tableheaderText = 'Revenue';
