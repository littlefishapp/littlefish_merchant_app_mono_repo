...
class OverviewReportVM extends StoreViewModel with ReportVMBase {
  OverviewReportVM.fromStore(Store<AppState> store) : super.fromStore(store);

  List<OverviewComparisonReport>? report = [];
  ...
  downloadReport(
    ...
    String filePath = await service.downloadOverviewReport(
      fileType,
      reportData,
      busDetails,
    );
