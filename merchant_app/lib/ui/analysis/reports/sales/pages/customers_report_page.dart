...
import 'package:littlefish_merchant/ui/analysis/reports/customers/customers_report_display.dart';
...
class CustomersReportPage extends StatefulWidget {
  static const String route = 'dashboard/customer';

  const CustomersReportPage({Key? key}) : super(key: key);
...
class _CustomersReportPageState extends State<CustomersReportPage>
  ...
  Widget build(BuildContext context) {
    ...
    vm ??= CustomersReportVM.fromStore(store)
          ...
          Expanded(
            child: AppTabBar(
              ...
              tabs: [
                TabBarItem(
                  text: '1d',
                  content: CustomersReportDisplay(report: vm),
                ),
                TabBarItem(
                  text: '1w',
                  content: CustomersReportDisplay(report: vm),
