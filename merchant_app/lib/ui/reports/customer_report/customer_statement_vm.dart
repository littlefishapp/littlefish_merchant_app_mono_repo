...
class CustomerStatementVM extends StoreViewModel<AppState> with ReportVMBase {
            ...
            .then((result) {
              ...
              if (result == null) {
                ...
                Navigator.of(ctx!).push(
                  MaterialPageRoute(
                    builder: (ctxx) => CustomerStatementPage(vm: this),
                  ),
                );
              }
            })
  ...
  Future<CustomerOverview?>? buildReport(
    vm,
    ctx,
    selectedCustomer,
    startDate,
    ...
    if (selectedCustomer == null) {
      showMessageDialog(ctx, 'Please select a customer', LittleFishIcons.info);
      ...
      reportService
          ...
          .then((result) {
            ...
            if (result == null) {
              ...
              Navigator.of(ctx).push(
                MaterialPageRoute(
                  builder: (ctxx) => CustomerStatementPage(vm: vm),
                ),
              );
            }
          })
