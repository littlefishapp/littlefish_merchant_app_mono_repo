...
import 'package:littlefish_merchant/ui/reports/customer_report/customer_data_table.dart';
import 'package:littlefish_merchant/ui/reports/customer_report/customer_filter_page.dart';
...
class CustomerStatementPage extends StatefulWidget {
  static const route = 'report/customer-statement';
  final CustomerStatementVM? vm;

  const CustomerStatementPage({Key? key, this.vm}) : super(key: key);
...
class _CustomerStatementPageState extends State<CustomerStatementPage> {
  ...
  AppSimpleAppScaffold _layout() => AppSimpleAppScaffold(
          ...
          SizedBox(
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  // TODO(lampian): rework Summarycard calls
                  SummaryCard(
                    context,
                    value:
                        vm.reportData?.totalSaleValue?.toStringAsFixed(2) ??
